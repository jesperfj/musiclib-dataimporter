...
// This is a copy of com.sforce.async.CSVReader modified with a getter and setter
// for fileSizeInCharacters so it can be changed from outside the class.
// TODO: Update WSC with this change and get rid of this copy.
...
public class CSVReader {
                ...
                while(true) {
                    ...
                    if (token == '"') {
                        ...
                        if (nextToken == StreamTokenizer.TT_WORD) {
                            throw new CSVParseException("Not expecting more text after end quote at line "+parser.lineno(), parser.lineno());
                        } else {
                            parser.pushBack();
                            break;
                        }
    ...
    public int getFileSizeInCharacters() {
		return fileSizeInCharacters;
	}

	public void setFileSizeInCharacters(int fileSizeInCharacters) {
		this.fileSizeInCharacters = fileSizeInCharacters;
	}
